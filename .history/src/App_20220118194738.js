...
const App = () => {
  ...
  const [items, setItems] = useState([
    { itemName: "item 1", quantity: 1, price: 100, isSelected: false },
    { itemName: "item 2", quantity: 3, price: 100, isSelected: true },
  ...
  const handleCalculations = (event) => {
    items.isSelected ? console.log("asa"): console.log("sad");
  }
